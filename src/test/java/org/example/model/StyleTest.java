...
class StyleTest {
    ...
    void getStyle_withValidLevel_returnsCorrectStyle() {
        ...
        // Styles should be different for different levels
    ...
    void getFont_withScale_returnsScaledFont() {
        ...
        // The scaled font should have a larger size
    ...
    void toString_afterInitialization_containsAllAttributes() {
        ...
        assertTrue(result.contains("25"));  // Should contain indent
        assertTrue(result.contains("18"));  // Should contain font size
        assertTrue(result.contains("12"));  // Should contain leading
    }
} 